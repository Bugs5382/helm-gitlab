...
3. Commit using Conventional Commits (`type(scope): description`). No attribution
   trailers. Emoji are welcome everywhere (docs, NOTES, source).
...
enforce Conventional Commits and the no-AI-tell rule before you push; CI enforces
